...
De forma geral, a empresa é bem avaliada pelos clientes. Conforme a coleta de dados realizada, em uma escala de **0** a **10**, a companhia teve uma média de **`r media`** na Recomendação, sendo que **`r recomendacao_10`%** das notas avaliada foram 10. Desta forma, é possível observar no "mapa do calor abaixo", uma maior concentração no topo do gráfico (especialmente, com notas **10**, que corresponde **`r recomendacao_10`%** do total, 9 e 8) e uma
